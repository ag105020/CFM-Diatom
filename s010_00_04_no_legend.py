...
h = genfromtxt('C:\\Users\\Keiin\\OneDrive\\Desktop\\figures\\01\\Diatoms\\Mu_Same_energy_2.csv',delimiter=',')
...
plot(V[:,0,0]*10**18,Muday_diatom[:,0,0], linewidth=3.5, color='red', label='Diatom',zorder=10)
plot(V[:,0,0]*10**18,h, "--",linewidth=3, color='red', label='Diatom*')
