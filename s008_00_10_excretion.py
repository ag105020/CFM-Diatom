...
# st(V[:,0,0]*10**18,"","V")
# st(Muday_diatom[:,0,0],"","Mu_diatom")
# st(Muday_other[:,0,0],"","Mu_other")

figure(4)
# plot(10**data_diatom[0],data_diatom[1],'o',markersize=10,color='none',markeredgecolor='red',markeredgewidth=2.5)
# plot(10**data_others[0],data_others[1],'o',markersize=10,color='none',markeredgecolor='cyan',markeredgewidth=2.5)
V_def = genfromtxt("C:\\Users\\keiin\\OneDrive\\Desktop\\figures\\01\\Diatoms\\V.csv",delimiter=",")
Mu_diatom = genfromtxt("C:\\Users\\keiin\\OneDrive\\Desktop\\figures\\01\\Diatoms\\Mu_diatom.csv",delimiter=",")
Mu_other = genfromtxt("C:\\Users\\keiin\\OneDrive\\Desktop\\figures\\01\\Diatoms\\Mu_other.csv",delimiter=",")

plot(V_def,Mu_diatom, linewidth=3.5,  color='red', label='Diatom (no exc.)')
plot(V[:,0,0]*10**18,Muday_diatom[:,0,0], '--',linewidth=3.5, color='red', label='Diatom (exc.)')
plot(V_def,Mu_other, linewidth=3.5, color='cyan', label='Non-Diatom (no exc.)')
plot(V[:,0,0]*10**18,Muday_other[:,0,0], '--',linewidth=3.5, color='cyan', label='Non-Diatom (exc.)')
